...
public interface IWatchListRepository
{
    ...
    Task<(List<WatchListItemDto> items, int count)> GetWatchListItemAndItsCountAsync(string userId, int pageNumber, int pageSize, CancellationToken cancellationToken = default);
